...
Current verified remote repository identity for this projection:

- default branch: `master`
- HEAD: `ddf1c09873599efe5f4976f7dc6456a65474b9b6`
...
Use BirdEye when the routed workflow selects it as the governed local evidence layer and its workspace/revision/search/inspect/run capabilities fit the investigation. Use LoopTool when explicitly requested, when selected as the direct local execution bridge, or when BirdEye cannot provide the required evidence path.

Do not duplicate the same command through both channels without a specific cross-validation reason.
